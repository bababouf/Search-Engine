...
public class BuildIndexTest {
    ...
    public void readInSystemModeTest() {
        ...
        try {
            int result = DiskPositionalIndexer.readInSystemMode(new Scanner(System.in));
     ...
     */
    @Test
    public void readInPathTest() {
        setUpStreams();
        setInput("test-corpus");
        Path absolutePath;

        try {
            absolutePath = DiskPositionalIndexer.readInPath(new Scanner(System.in));
            ...
            String actualPathAsString = absolutePath.toString();
